...
We as contributors and maintainers pledge to make participation in WorldResetPlugin and our community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.
...
- Giving credit when using or building on someone else's work.
...
- Deliberately disrupting community spaces (spam, flooding issues, off-topic promotion).
...
This Code of Conduct applies within all community spaces associated with WorldResetPlugin — including the GitHub repository (issues, pull requests, discussions, code review comments) and any other official communication channels. It also applies when an individual is officially representing the project in public spaces.

---

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the project maintainers via the contact information listed in the repository. All complaints will be reviewed and investigated promptly and fairly.
